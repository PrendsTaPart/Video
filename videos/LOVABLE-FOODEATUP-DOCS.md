...
| 1 | Agent IA Caroline | 01 - Configurer Caroline (voix & prompts) | `configurer-caroline-voix-prompts` | **oui** — `create_order`. Premier tutoriel du module `caroline-ia` (0/6 avant celui-ci, catalogue 6a-01). Rush montre Configuration voix (prompt système, voix/langue/numéro, message d'accueil, Enregistrer) **puis** la Marketplace de prompts FoodEatUp filmée en réel (filtre Commandes → copie du prompt → collé dans Claude.ai qui orchestre) : pas de séquence Claude synthétique cette fois, le rush la capture déjà. 43,0 s, voix Adam FR, peak -7,2 dBFS. Validation groupée par Michael (script + voix + montage + publication en une demande). Publiée : RapidoCMS (`foodeatup-caroline-voix-tuto-v1` / `foodeatup-caroline-voix-tuto-thumbnail`) + LinkedIn/Facebook FoodEatUp programmés 2026-08-21 07h (rotation LinkedIn pleine jusqu'au 2026-08-20) + Lovable (a remplacé le placeholder préexistant `configurer-caroline`, `section: "Configurer Caroline"`, `order: 1`, commit `0be4efd`). |
