...
| 19 | Comptabilité | 3- Créer un devis | `creer-un-devis` | **oui** — `create_quote` (client/produit/quantité/prix/TVA), même structure que les champs à l'écran. Rush conforme au dossier Drive (taille de fichier vérifiée). Sans avatar HeyGen. Montée le 2026-08-03 — **en attente de validation de Michael avant publication Lovable** (vidéo livrée via SendUserFile, pas encore confirmée) |
