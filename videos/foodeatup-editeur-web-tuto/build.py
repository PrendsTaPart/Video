#!/usr/bin/env python3
# FoodEatUp "Activer l'abonnement Éditeur de site" tutorial (module site-web-vitrine, 01/08).
# Same engine as foodeatup-abonnement-tuto: setpts for speed (never zoompan on real
# footage -- freezes the image), xfade on every cut, forced back to yuv420p at the
# end of the chain, 48kHz stereo AAC +faststart. No avatar clip: full ElevenLabs VO.
import subprocess, os

ROOT = "/home/user/Video/videos/foodeatup-editeur-web-tuto"
...
# instants: "Ajouter cette option" click ~7.65-7.85s, "Continuer vers le paiement"
# click ~12.80-12.90s (see contact-sheet analysis / SCRIPT.md).
BTN_AJOUTER   = (368, 673); SZ_AJOUTER   = (456, 70)
BTN_CONTINUER = (1025, 688); SZ_CONTINUER = (326, 52)

# (name, src_start, src_end, target_out_duration, click_time_or_None, button, btn_size, caption)
segs = [
    ("A", 3.50,  7.60,  3.60, None,  None,          None,          "1 · Options & modules"),
    ("B", 7.60,  7.85,  0.90, 7.65,  BTN_AJOUTER,    SZ_AJOUTER,    None),
    ("C", 7.85,  9.20,  6.50, None,  None,          None,          "2 · Récapitulatif"),
    # 9.20 -> 12.55 cut: champ code promo laissé à l'écran, rien de nouveau ne se
    # passe avant le clic sur "Continuer vers le paiement" (même logique que les
    # coupures de temps mort sur foodeatup-abonnement-tuto).
    ("D", 12.55, 12.90, 1.00, 12.85, BTN_CONTINUER, SZ_CONTINUER,  None),
    # 12.90 -> 14.20 cut: spinner/squelette de chargement Stripe, rien à commenter.
    ("E", 14.50, 16.80, 7.50, None,  None,          None,          "3 · Vérification & paiement"),
]
INTRO_D, OUTRO_D = 5.00, 6.00
...
def build_silent(outro_d):
    ...
    trans = ["fade","fade","fade","fade","fade","fade"]
...
FINAL = f"{ROOT}/out/foodeatup-editeur-web-tuto-v1.mp4"
