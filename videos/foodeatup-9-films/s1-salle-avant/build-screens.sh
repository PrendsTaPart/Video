...
seg s2a POINTAGE    7.0  2.40        #  7,39 -> 11,95 : « je pointe,
seg s2b TACHES     10.0  2.40  260   #                   je récupère mes tâches »
seg s3  RESAS       3.5  6.75        # 11,95 -> 18,47 : les réservations du jour
seg s4  APPELS      6.0 11.25        # 18,47 -> 29,52 : les appels de la nuit
seg s5  AJOUT-RESA 12.0  5.45        # 29,52 -> 34,76 : une réservation de plus
...
seg s6  CRENEAUX   20.3  6.15        # 34,76 -> 40,68 : je ferme le créneau
seg s7  TABLES     18.0  5.00        # 40,68 -> 45,48 : la six est bancale
seg s8  PLACER     10.0  5.95        # 45,48 -> 51,24 : mon plan de salle
seg s9  QRCODE      8.0  7.20        # 51,24 -> 58,24 : les QR codes des tables
seg s10 WEB        16.0  5.95        # 58,24 -> 64,00 : les commandes web

concat_c SCENE-2 s2a s2b
for n in 3 4 5 6 7 8 9 10; do cp "$TMP/s$n.mp4" "$OUT/SCENE-$n.mp4"; done

echo "--- durée obtenue / durée de scène (la bobine doit dépasser) ---"
declare -A SCENE=([SCENE-2]=4.56 [SCENE-3]=6.52 [SCENE-4]=11.05 [SCENE-5]=5.24
                  [SCENE-6]=5.92 [SCENE-7]=4.80 [SCENE-8]=5.76 [SCENE-9]=7.00 [SCENE-10]=5.76)
