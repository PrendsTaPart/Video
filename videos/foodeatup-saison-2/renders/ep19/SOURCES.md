# Épisode 19 « La course-poursuite » — provenance
...
|---|---|---|
| Scène 1 — « C'est pas ici » | `8243f203-3d3b-4349-a4cb-91ed3ecbd544` | `source/ep19-scene1.mp4` |
| Scène 2 — « Trente kilomètres » | `e0afe77b-f30e-4bcb-bc59-786da89a1839` | `source/ep19-scene2.mp4` |
...
`prompts/ep19-la-course-poursuite.md`, à une différence près : la référence visage y est passée en
...
| Fichier | Contenu |
|---|---|
| `ep19-la-course-poursuite.mp4` | **Le master** : scène 1 + scène 2 + transition + animation, 1080×1920, 30 fps, 32,1 s |
| `ep19-outro.mp4` | L'outro seul, 12 s, voix off + SFX |
| `ep19-outro-muet.mp4` | L'outro seul, 12 s, SFX uniquement |
| `vo.mp3` | La voix off de l'épisode, normalisée |
| `ep19-thumb.png` | Miniature : le plan figé du début de l'outro + le titre |
