# Épisode 23 « La mémoire » — provenance
...
|---|---|---|
| Scène 1 — « D'habitude » | `68dc9e1b-cf1f-42c4-817d-39a6d1946ab6` | `source/ep23-scene1.mp4` |
| Scène 2 — « Une omelette » | `19560430-ac76-4c1b-94d9-c1e1ae1fb959` | `source/ep23-scene2.mp4` |
...
`prompts/ep23-la-memoire.md`, à une différence près : la référence visage y est passée en
...
| Fichier | Contenu |
|---|---|
| `ep23-la-memoire.mp4` | **Le master** : scène 1 + scène 2 + transition + animation, 1080×1920, 30 fps, 32,1 s |
| `ep23-outro.mp4` | L'outro seul, 12 s, voix off + SFX |
| `ep23-outro-muet.mp4` | L'outro seul, 12 s, SFX uniquement |
| `vo.mp3` | La voix off de l'épisode, normalisée |
| `ep23-thumb.png` | Miniature : le plan figé du début de l'outro + le titre |
...
| Ligne de l'épisode | « Ses habitudes, vous les connaissez, même sans mémoire. FoodEatUp garde l'historique, les préférences et la fidélité de chaque client. » |
| Prise retenue | `FXtGSHkI1jUoEK6SVeeP` (5,43 s) |
