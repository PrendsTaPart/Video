# Épisode 08 « Le documentaire » — provenance
...
|---|---|---|
| Scène 1 — « Le client qui filme » | `f260ccf9-3023-4bb3-b7d8-d3062b402a32` | `source/ep08-scene1.mp4` |
| Scène 2 — « Le cycle recommence » | `bb74186e-89a2-43bd-beca-4e3433ee4c86` | `source/ep08-scene2.mp4` |
...
`prompts/ep08-le-documentaire.md`, à une différence près : la référence visage y est passée en
...
| Fichier | Contenu |
|---|---|
| `ep08-le-documentaire.mp4` | **Le master** : scène 1 + scène 2 + transition + animation, 1080×1920, 30 fps, 32,1 s |
| `ep08-outro.mp4` | L'outro seul, 12 s, voix off + SFX |
| `ep08-outro-muet.mp4` | L'outro seul, 12 s, SFX uniquement |
| `vo.mp3` | La voix off de l'épisode, normalisée |
| `ep08-thumb.png` | Miniature : le plan figé du début de l'outro + le titre |
...
| Ligne de l'épisode | « Vos clients font votre pub. FoodEatUp la récupère : la photo, l'avis, les points de fidélité. » |
| Prise retenue | `urjMjG9PVxCTSwYJEaH0` (5,85 s) |
...
| | |
|---|---|
| Épisode au catalogue | `EPC08` — série `michael-fait-son-cinema`, saison 2 |
| Pièce | `master` |
| État | **pret** |
| Fichier | https://rapido-software.s3.eu-west-3.amazonaws.com/rapidosoftware/cms/bibliotheque/michael-fait-son-cinema-EPC08-le-documentaire-master |
