# Épisode 18 « Les douze » — provenance
...
|---|---|---|
| Scène 1 — « Douze familles » | `2c1b4679-fd3c-4db9-b5dd-7c4399f4ebcd` | `source/ep18-scene1.mp4` |
| Scène 2 — « Pardon » | `39acf7eb-1444-4493-91a1-fb743e4d3cf1` | `source/ep18-scene2.mp4` |
...
`prompts/ep18-les-douze.md`, à une différence près : la référence visage y est passée en
...
| Fichier | Contenu |
|---|---|
| `ep18-les-douze.mp4` | **Le master** : scène 1 + scène 2 + transition + animation, 1080×1920, 30 fps, 32,1 s |
| `ep18-outro.mp4` | L'outro seul, 12 s, voix off + SFX |
| `ep18-outro-muet.mp4` | L'outro seul, 12 s, SFX uniquement |
| `vo.mp3` | La voix off de l'épisode, normalisée |
| `ep18-thumb.png` | Miniature : le plan figé du début de l'outro + le titre |
...
| Ligne de l'épisode | « Douze ou cinquante, tout est écrit : la demande, le devis, la salle, la facture. FoodEatUp gère vos privatisations de bout en bout. » |
| Prise retenue | `pbec8pbxWpKYf90d5wQn` (6,5 s) |
