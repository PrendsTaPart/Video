# Épisode 17 « Le round » — provenance
...
|---|---|---|
| Scène 1 — « Encore » | `42de5879-32a2-4091-94bd-f736b5e8309e` | `source/ep17-scene1.mp4` |
| Scène 2 — « Il en manque une » | `f029fff4-2c7a-4417-a158-235a992c538e` | `source/ep17-scene2.mp4` |
...
`prompts/ep17-le-round.md`, à une différence près : la référence visage y est passée en
...
| Fichier | Contenu |
|---|---|
| `ep17-le-round.mp4` | **Le master** : scène 1 + scène 2 + transition + animation, 1080×1920, 30 fps, 32,1 s |
| `ep17-outro.mp4` | L'outro seul, 12 s, voix off + SFX |
| `ep17-outro-muet.mp4` | L'outro seul, 12 s, SFX uniquement |
| `vo.mp3` | La voix off de l'épisode, normalisée |
| `ep17-thumb.png` | Miniature : le plan figé du début de l'outro + le titre |
...
| Ligne de l'épisode | « Trois cents crêpes, c'est un plan de production. FoodEatUp calcule les ingrédients, prévient ce qui manque et met le stock à jour. » |
| Prise retenue | `K8ywYl60KIlIe3L3evCa` (5,57 s) |
| Calage | démarre à **4,60 s**, se termine à **10,17 s** (fenêtre : avant 11,0 s) ✅ |
