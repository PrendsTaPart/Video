...
| `sfx/clap.wav` | — | ⚠️ **manquant** — à sourcer |
| `sfx/whoosh.wav` | — | ⚠️ **manquant** — à sourcer |
| `sfx/tick.wav` | `videos/serie-30-e01/assets/sfx/click-soft.mp3` | 🔁 substitut acceptable |
| `sfx/impact.wav` | `videos/serie-30-e01/assets/sfx/impact-bass-1.mp3` | 🔁 substitut acceptable |
