...
## CLAUDE CODE — 12 s (outro ep30 : 2 s de transition + 10 s d'animation)

**Voix off — transition** (commune aux 30 épisodes, à 2,1 s) : « Cette scène aurait pu être évitée ? »

**Voix off — épisode** (à 4,6 s) : « Trente films. Un restaurant. Un seul système. FoodEatUp. »
...
Voix off de l'épisode (démarre à 4,6 s, finie avant 11,0 s) : « Trente films. Un restaurant. Un seul système. FoodEatUp. »
