#!/usr/bin/env python3
# FoodEatUp "Débloquer les Avis clients" tutorial (module marketing-fidelite, 01/24).
# No avatar clip, no Claude sequence (achat d'option = paiement Stripe, aucun
# outil MCP correspondant -- voir SCRIPT.md). Full ElevenLabs VO throughout.
...
ROOT = "/home/user/Video/videos/foodeatup-avis-abonnement-tuto"
...
# Coordinates measured on the 1920x828 source rush (1fps sweep + 4fps sweeps
# around each click, see SCRIPT.md).
BTN_AJOUTER   = (367, 671);  SZ_AJOUTER  = (456, 60)   # "Ajouter cette option" (carte Avis)
BTN_CONTINUER = (1025, 689); SZ_CONTINUER = (326, 50)  # "Continuer vers le paiement" (modal)

# (name, src_start, src_end, target_out_duration, click_time_or_None, button, btn_size, caption)
segs = [
    ("A", 0.00, 9.50,  6.30,  None,  None,          None,          "1 · Options et modules"),
    ("B", 9.50, 9.80,  0.90,  9.60,  BTN_AJOUTER,   SZ_AJOUTER,    None),
    ("C", 9.80, 11.70, 10.30, None,  None,          None,          "2 · Récapitulatif de commande"),
    ("D", 11.70, 12.00, 0.90,  11.80, BTN_CONTINUER, SZ_CONTINUER, None),
    ("E", 12.00, 19.72, 9.20,  None,  None,          None,          "3 · Paiement sécurisé Stripe"),
]
INTRO_D, OUTRO_D = 5.65, 6.20
...
FINAL = f"{ROOT}/out/foodeatup-avis-abonnement-tuto-v1.mp4"
