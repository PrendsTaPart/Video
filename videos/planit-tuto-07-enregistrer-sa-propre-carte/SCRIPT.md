...
| N1 | Un nouveau prompt | Voici l'écran d'un nouveau prompt. Quatre champs suffisent à transformer une consigne en carte. |
| N2 | Le nom | Donnez-lui un nom qui décrit le résultat : « Rappel commande fournisseur ». |
| N3 | La description | La description dit à quoi elle sert. C'est ce que liront vos collègues. |
| N4 | Une première variable | Viennent les variables : tout ce qui change d'une fois à l'autre. Ici, le nom du fournisseur. |
...
| N12 | Réutilisable | Votre meilleure consigne, réutilisable en un geste. |
