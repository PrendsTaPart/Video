#!/usr/bin/env python3
# FoodEatUp "Piocher dans la marketplace de prompts" tutorial (module PrediBot).
# No synthetic Claude 3-stage overlay here: the real screen recording already
# shows the full round-trip (marketplace -> Tester en live -> Claude -> retour
# FoodEatUp), unlike the other tutos where that sequence is a bonus tip.
...
ROOT = "/home/user/Video/videos/foodeatup-predibot-marketplace-tuto"
...
BTN_TESTER = (1420, 533); SZ_TESTER = (325, 51)  # "Tester en live" (Crée un nouveau fournisseur)
BTN_SEND   = (1740, 731); SZ_SEND   = (46, 46)   # bouton d'envoi Claude (flèche orange)

# (name, src_start, src_end, target_out_duration, click_time_or_None, button, btn_size, caption)
segs = [
    ("A", 0.30, 12.00, 5.80, None, None,       None,       "1 - Une marketplace de 182 prompts"),
    ("B", 14.60, 15.90, 0.90, 15.10, BTN_TESTER, SZ_TESTER, None),
    ("C", 15.90, 25.50, 4.60, None, None,       None,       "2 - Direction Claude"),
    ("D", 42.00, 113.30, 6.00, None, None,      None,       "3 - Repondez, Claude remplit le reste"),
    ("E", 113.30, 114.30, 0.90, 113.80, BTN_SEND, SZ_SEND,  None),
    ("F", 114.30, 122.60, 3.60, None, None,      None,      "Fournisseur cree"),
    ("G", 127.00, 141.50, 4.60, None, None,      None,      "4 - Retour sur FoodEatUp"),
]
INTRO_D, OUTRO_D = 5.90, 6.20
...
FINAL = f"{ROOT}/out/foodeatup-predibot-marketplace-tuto-v1.mp4"
