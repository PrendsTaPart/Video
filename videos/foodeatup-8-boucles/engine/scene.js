...
(function () {
  ...
  var NOEUDS = [
    // Boucle gestion (lobe gauche) puis boucle vente (lobe droit).
  ...
  function bâtirPlan5(root, d) {
    ...
    root._noeuds = NOEUDS.map(function (n, i) {
      // Les huit nœuds répartis sur la courbe, en sautant le croisement central.
      var u = (i + 0.5) / 8;
      var p = pointInfini(u, rx, ry);
