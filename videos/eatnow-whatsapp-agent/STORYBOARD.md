---
format: 1080x1080 (master) → décliné 1080x1920 (9:16)
fps: 24
duration: 22-24s
...
- asset_candidates: mockup téléphone (à vendorer, style sobre, pas de skin iOS/Android trop marqué), icône "en ligne" (point vert petit format, toléré car statut système WhatsApp)
...
## Plan 4 — La réservation se prend
...
## Plan 5 — Ça tombe dans le carnet
...
## Plan 6 — Un agent qui répond et réserve
...
- duration: 4.0s (20–24s)
- transition_in: cut retour Ink (bouclage visuel avec le plan 1)
- status: à composer — PLACEHOLDER logo/wordmark en attendant le vrai kit de marque (voir SCRIPT.md § Statut assets)
