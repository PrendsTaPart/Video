...
# screen blocks
report['C']=screen_block("C",f"{SEG}/segC.mp4",[(R(1),0,9)],f"{PNG}/etape1.png",zoom_c=(0.5,0.5),blur_band=(1120,420))
report['D']=screen_block("D",f"{SEG}/segD.mp4",[(R(2),0,8.6)],f"{PNG}/etape2.png",zoom_c=(0.5,0.5),blur_band=(1120,460))
report['E']=screen_block("E",f"{SEG}/segE.mp4",[(R(4),0,18.8)],f"{PNG}/etape3.png",zoom_c=(0.5,0.55),blur_band=(560,340))
report['F']=screen_block("F",f"{SEG}/segF.mp4",[(R(5),0,13)],f"{PNG}/etape4.png",zoom_c=(0.5,0.5),blur_band=(120,180))
report['G']=screen_block("G",f"{SEG}/segG.mp4",[(R(3),0,9.1),(R(4),3,11)],f"{PNG}/etape5.png",zoom_c=(0.5,0.5),blur_band=(560,340))
