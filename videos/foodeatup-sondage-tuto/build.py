#!/usr/bin/env python3
# FoodEatUp "Créer un sondage" tutorial (module marketing-fidelite).
# Same engine as foodeatup-editeur-web-tuto / foodeatup-abonnement-tuto: setpts for
# speed (never zoompan on real footage -- freezes the image), xfade on every cut,
# forced back to yuv420p at the end of the chain, 48kHz stereo AAC +faststart.
# No avatar clip: full ElevenLabs VO.
import subprocess, os

ROOT = "/home/user/Video/videos/foodeatup-sondage-tuto"
...
# Button coordinates measured on full-resolution frames (1920x828) at the click
# instants: "Créer un sondage" click ~1.85-2.05s, "Enregistrer le sondage" click
# ~64.8-65.05s (see contact-sheet analysis / SCRIPT.md).
BTN_CREER      = (1660, 741); SZ_CREER      = (230, 50)
BTN_ENREGISTRER = (948, 674); SZ_ENREGISTRER = (280, 60)

# (name, src_start, src_end, target_out_duration, click_time_or_None, button, btn_size, caption)
segs = [
    ("A",  0.00,  1.85,  5.00, None,  None,            None,            "1 · Créer un sondage"),
    ("B",  1.85,  2.05,  0.90, 1.90,  BTN_CREER,        SZ_CREER,        None),
    ("C",  2.05, 23.00,  8.50, None,  None,            None,            "2 · Titre, déclencheur & récompense"),
    ("D1", 23.00, 42.00, 6.60, None,  None,            None,            "3 · Ajoutez vos questions"),
    ("D2", 42.00, 64.80, 7.00, None,  None,            None,            "4 · Choix multiples & options"),
    ("E",  64.80, 65.05, 0.90, 64.90, BTN_ENREGISTRER,  SZ_ENREGISTRER,  None),
    # 65.05 -> 67.00 cut : rechargement de la liste (flash "Aucun sondage"), rien
    # à commenter avant l'affichage de la carte finale.
    ("F",  67.00, 70.00, 5.80, None,  None,            None,            None),
]
...
FINAL = f"{ROOT}/out/foodeatup-sondage-tuto-v1.mp4"
