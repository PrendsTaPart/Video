...
colors:
  ...
  text-muted: "#6B6B6B"
  text-light: "#9A9A9A"
  accent-light: "rgba(30, 155, 240, 0.08)"
  accent-medium: "rgba(30, 155, 240, 0.15)"
  border: "rgba(30, 155, 240, 0.2)"
  card-bg: "rgba(30, 155, 240, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Poppins** (display) / **Inter** (body); ignore any preset font name lingering in prose.
...
@font-face{font-family:"Poppins";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/Poppins-Regular.woff2") format("woff2");}
</style>
```
