...
| RÉSULTAT (HeyGen) | 25–33s | ⏳ en attente | script ci-dessous, avatar Mika (voir `studio-video/CLAUDE.md`) — HEYGEN_API_KEY absente de cette session, à refournir ou généré manuellement |
