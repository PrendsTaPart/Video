...
À quoi ça sert : Vos devis et vos factures appliquent les taux que vous déclarez ici. Tant que la liste est vide, aucun taux n'est disponible au moment de facturer. Un taux se crée en deux champs, et se corrige d'un clic si la loi ou votre activité change.
Pour qui : Gérant, comptable, ou toute personne chargée de la facturation
Prompt Claude : Liste-moi mes [nombre] dernières factures avec leur montant total.

Étapes observées :
- 1. Ouvrir l'onglet TVA — fenêtre 4.0s, soit ~10 mots
- 2. Ajouter un taux — fenêtre 10.5s, soit ~26 mots
- 3. Confirmer l'ajout — fenêtre 4.0s, soit ~10 mots
- 4. Modifier un taux — fenêtre 9.0s, soit ~22 mots
- 5. Vérifier le nouveau taux — fenêtre 4.8s, soit ~12 mots

Astuces : Modifier plutôt que recréer · La traçabilité est à côté
Erreurs fréquentes : Créer un second taux au lieu de corriger le premier : l'icône crayon de la colonne Action modifie la ligne existante. · Laisser la liste vide et découvrir au moment de facturer qu'aucun taux n'est disponible.
