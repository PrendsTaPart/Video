...
- 1. Ouvrir la section Stripe (0.0s → 2.5s)
- 2. Situer Stripe parmi les connexions (2.5s → 8.0s)
- 3. Retrouver la page Profil et ses onglets (8.0s → 15.0s)
- 4. Coller la clé secrète (15.0s → 17.5s)
- 5. Enregistrer (17.5s → 18.9s)
...
- Divergence : « champ Clé secrète stripe » (16.0s) ne correspond à aucun paramètre des outils MCP retenus — à décrire depuis la frame, pas depuis un schéma.
