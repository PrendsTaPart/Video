...
- 1. Ouvrir l'historique des e-mails (0.5s → 7.0s)
- 2. Lire le tableau des envois (7.0s → 10.0s)
- 3. Rouvrir un e-mail envoyé (10.0s → 15.0s)
- 4. Revenir à la liste (15.0s → 15.8s)
